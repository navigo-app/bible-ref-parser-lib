use crate::title_hashmap::TitleMap;
...
impl Parsing {
        ...
        if !book_span_re.is_match(vec_ref.as_str()) {
            ...
            for split_r in split_rs.iter() {
                if book_span_re.is_match(split_r) {
                    agg_refs.push(Self::span_ref_to_id_code(split_r, &titles, &my_map));
                    ...
                    if !book_span_re.is_match(o_ref.as_str())
                        ...
                        agg_refs.push(Self::process_bcv_ref(&o_ref));
                    }
                } else {
    ...
    pub fn process_bcv_ref(other_ref: &String) -> String {
        let result = Self::parse_compound_ref(&other_ref);
        ...
        let temp_code_bcv_refs: Vec<String> = book_chapter_verses
            .iter()
            .map(|bcv_ref| Self::bcv_ref_to_id_code(bcv_ref))
    ...
    pub fn iterative_parse(input: Vec<String>) -> Vec<String> {
        ...
        loop {
            ...
            output = output
                .into_iter()
                .flat_map(Self::parse_chapter_verse)
                .collect();
    ...
    pub fn bcv_ref_to_id_code(bcv_ref: &str) -> Result<String, &'static str> {
    ...
    pub fn parse_chapter_verse(input: String) -> Vec<String> {
        ...
        */
            ...
            return Self::parse_comma_verses(input);
        }
    ...
    pub fn parse_comma_verses(input: String) -> Vec<String> {
        ...
        // parse chapter and verses
            ...
            for verse in verses {
                ...
                // recursively call the function until the reference contain only one chapter:verse
                    ...
                    for element in Self::parse_comma_verses(remaining_verses) {
